/*
  ...
  Arrays, Functions, Classes and so on do not need to be taken into
  consideration. However, you can still challenge yourself by covering as many
...
type x1 = DeepReadonly<X1>;
type x2 = DeepReadonly<X2>;
